...
$(this).after('<p class="all_imgcenter"><img class="loader_wt" src="https://www.webtady.com/wp-content/themes/webtady/img/webtady-image-loader.gif" /></p>') // some preloaded "loading" image
                 .hide()
                 .attr('src',this.src)
                 .one('load', function() {
...
/*
 jQuery(document).ready(function ($) {
            ...
            //Collapse Random
            { $Duration: 1500, y: -1, $Cols: 10, $Rows: 4, $Clip: 15, $During: { $Top: [0.5, 0.5], $Clip: [0, 0.5] }, $Formation: $JssorSlideshowFormations$.$FormationStraight, $ChessMode: { $Column: 12 }, $ScaleClip: 0.5 }
